...
## 🟢 Step 1: Ingestion & Intent Recognition (Trigger)
...
## 🟡 Step 2: Ingestion - KS Data Extraction (Phase 1)
...
## 🟠 Step 3: Synthesis - Requirement Transformation (Phase 2)
...
## 🔵 Step 4: Formatting & Preview Drafting (Phase 3)
...
## 🟣 Step 5: Jira Injection - System Provisioning (Phase 4)
...
## 🟤 Step 6: Epic Linking & Finalization (Phase 5)
...
## 🧰 Auxiliary Step: Ad-hoc Task Reorganization (Phase 6)
