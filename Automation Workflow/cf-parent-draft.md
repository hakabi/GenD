...
| Field | Value |
| --- | --- |
| **Title (Jira/Confluence request)** | Skill Classification for ALT — *interpreted as **ATL** (Automation Testing Lifecycle); update title in Confluence if you strictly require the acronym "ALT".* |
...
The detailed specifications continue on the following child pages (same publication set):

1. [Skill Classification for ALT — Detailed specs (skills 14–26 + annex)](PLACEHOLDER_PART2)

*(Part 2 link is inserted after the child page is created.)*
