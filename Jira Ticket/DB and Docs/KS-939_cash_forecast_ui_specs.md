...
> **Created:** 2026-01-07 · **Last Updated (local mirror):** 2026-07-02 *(42+ comments through May 2026 on KS-939; Jun–Jul decisions tracked on KS-1045)*  
> **Handoff:** [`cash_forecast_session_handoff.md`](./cash_forecast_session_handoff.md) · **Location:** `Jira Ticket/DB and Docs/`
...
### 🆕 Related decisions: Jun–Jul 2026 (KS-1045 thread — not all on KS-939)

| Date | Author | Summary |
|------|--------|---------|
| 2026-06-26 | Jerry Luo | Request **Excel download** on Dashboard; **remove as-of calendar picker** (screenshot) |
| 2026-06-30 | Kathleen Bui | **No** Historical tab Excel; questions whether as-of shows full forecast replay |
| 2026-06-30 | Bình | Tuan table: **partial as-of only** — chart not stored; beta=latest; transactions=current |
| 2026-06-30 | Kathleen Bui | Confirms **no full historical replay** (Thuyen: storage); Excel for **current** Dashboard version |
| 2026-07-01 | Bình | Ask: remove **entire** standalone As of Date section vs keep read-only label? |
| 2026-07-01 | Kathleen Bui | **"Your recommendation works for me"** → remove entire standalone section |

**Implementation tickets:** [KS-1049](https://gendvn.atlassian.net/browse/KS-1049) (Excel), [KS-1050](https://gendvn.atlassian.net/browse/KS-1050) (remove as-of). **KS-966** superseded → cancel after KS-1050. **KS-960** card header as-of subtitle **retained**.
...
## 📌 Key product decisions (full history through Jul 2026)
...
### From Jun–Jul 2026 (KS-1045 / Jerry + Kathleen)
- **Dashboard Excel export** — `.xlsx`, Dashboard sub-tab only; archive when no historical replay — Kathleen **20590** → **KS-1049**.
- **Remove standalone As of Date section** — picker, Return to Today, banner — Kathleen **20592** → **KS-1050**.
- **Retain KS-960 card header** read-only as-of subtitle (not the standalone control).
- **Full forecast replay by date** — **deferred**; partial as-of behaviour documented by Tuan (see handoff).
- **Details tab export** — **CSV** on **KS-970** (not Excel).
