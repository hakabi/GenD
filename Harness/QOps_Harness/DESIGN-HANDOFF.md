# 36ed4555-d1ab-4d48-a881-4c36758df1a6 implementation handoff
...
- `css/case-detail.css`
- `css/case-review.css`
- `css/case-workbench.css`
- `css/cases.css`
- `css/components.css`
- `css/request-dialog.css`
- `css/request-workbench.css`
- `css/requests.css`
- `css/runs.css`
- `css/shell.css`
- `css/tokens.css`
...
## Scripts/components
- `js/case-detail.js`
- `js/case-workbench.js`
- `js/icons.js`
- `js/knowledge-data.js`
- `js/mock-queue.js`
- `js/nl-flow.js`
- `js/request-execution-tree.js`
- `js/request-flow.js`
- `js/request-workbench-core.js`
- `js/request-workbench.js`
- `js/shell.js`
- `js/theme.js`

## Assets and supporting files
- `critique.json`
- `mr4gnn5z-drawing-2026-07-03T04-56-14-820Z.png`
- `mr4gszmn-drawing-2026-07-03T05-00-24-256Z.png`
